...
//#region resources/js/Pages/Master/settings/Index.jsx
var TABLE_COLUMNS = [
	"vIsi",
	"eTampil",
	"eTipe"
...
function Index() {
	...
	const handleDelete = (id) => {
		if (confirm("Yakin ingin menghapus data ini?")) router.delete(`/master/settings/${id}`);
	};
