...
//#region resources/js/Pages/Master/brand/Index.jsx
var TABLE_COLUMNS = ["vNama", "vPicture"];
function Index() {
	const { props } = usePage();
	...
	const handleSearch = (col, value) => {
		...
		const timer = setTimeout(() => {
			router.get(`/master/brand`, params, {
				preserveState: true,
				replace: true
			});
		}, 300);
	...
	const handleDelete = (id) => {
		if (confirm("Yakin ingin menghapus data ini?")) router.delete(`/master/brand/${id}`);
	};
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("table", {
									...
									children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
										...
										/* @__PURE__ */ jsxs("th", { children: [/* @__PURE__ */ jsx("h6", { children: "Picture" }), /* @__PURE__ */ jsxs("div", {
											className: "search-wrap",
											children: [/* @__PURE__ */ jsx("svg", {
												className: "search-icon",
												fill: "none",
												...
												placeholder: "Cari",
												className: "search-input",
												value: inputs["vPicture"] || "",
												onChange: (e) => handleSearch("vPicture", e.target.value)
											})]
										})] }, "vPicture"),
										...
										/* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsx("p", { children: formatValue("vPicture", item["vPicture"]) }) }, "vPicture"),
