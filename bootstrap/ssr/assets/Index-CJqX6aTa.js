...
//#region resources/js/Pages/Master/kategori-perusahaan/Index.jsx
...
function Index() {
	...
	const handleDelete = (id) => {
		if (confirm("Yakin ingin menghapus data ini?")) router.delete(`/master/kategori-perusahaan/${id}`);
	};
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("h6", {
									...
									href: `/master/kategori-perusahaan/create`,
