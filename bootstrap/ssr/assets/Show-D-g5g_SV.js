...
//#region resources/js/Pages/Master/users/Show.jsx
function Show() {
	const { props } = usePage();
					...
					children: [
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("p", {
										...
										children: fieldLabels["name"] || "name"
									}), /* @__PURE__ */ jsx("p", {
										className: "show-field-value",
										children: formatValue("name")
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "col-12 col-md-6 col-lg-4",
									children: [/* @__PURE__ */ jsx("p", {
										className: "show-field-label",
										children: fieldLabels["email"] || "email"
									}), /* @__PURE__ */ jsx("p", {
										className: "show-field-value",
										children: formatValue("email")
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "col-12 col-md-6 col-lg-4",
									children: [/* @__PURE__ */ jsx("p", {
										className: "show-field-label",
										children: fieldLabels["role"] || "role"
									}), /* @__PURE__ */ jsx("p", {
										className: "show-field-value",
										children: formatValue("role")
									})]
								})
							]
						}),
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("p", {
									className: "show-field-label",
									children: fieldLabels["password"] || "password"
								}), /* @__PURE__ */ jsx("p", {
									className: "show-field-value",
									children: "••••••••"
								})]
