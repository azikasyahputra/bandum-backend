...
//#region resources/js/Pages/Master/kelurahan/Index.jsx
var TABLE_COLUMNS = [
	"iIdProvinsi",
	"iIdKota",
	"iIdKecamatan",
...
function Index() {
	...
	const handleDelete = (id) => {
		if (confirm("Yakin ingin menghapus data ini?")) router.delete(`/master/kelurahan/${id}`);
	};
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("table", {
									...
									children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
										...
										/* @__PURE__ */ jsxs("th", { children: [/* @__PURE__ */ jsx("h6", { children: "Kode Pos" }), /* @__PURE__ */ jsxs("div", {
											className: "search-wrap",
											children: [/* @__PURE__ */ jsx("svg", {
												className: "search-icon",
												fill: "none",
										...
										/* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsx("p", { children: formatValue("vKodepos", item["vKodepos"]) }) }, "vKodepos"),
