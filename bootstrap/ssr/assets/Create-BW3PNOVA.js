import { i as InputFile, o as InputText } from "./InputPassword-DtsxK0Gz.js";
import { Head, Link, useForm, usePage } from "@inertiajs/react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
//#region resources/js/Pages/Master/brand/Create.jsx
function Form() {
	const { props } = usePage();
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx(InputFile, {
									field: "vPicture",
									label: fieldLabels["vPicture"] || "vPicture",
									value: data["vPicture"] ?? "",
									onChange: (v) => setData("vPicture", v),
									error: errors["vPicture"]
								})
							})]
						}), /* @__PURE__ */ jsx("div", {
