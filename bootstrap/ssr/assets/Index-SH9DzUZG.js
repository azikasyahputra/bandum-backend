...
//#region resources/js/Pages/Master/kecamatan/Index.jsx
var TABLE_COLUMNS = [
	"iIdProvinsi",
	"iIdKota",
	"vNama"
...
function Index() {
	...
	const handleDelete = (id) => {
		if (confirm("Yakin ingin menghapus data ini?")) router.delete(`/master/kecamatan/${id}`);
	};
