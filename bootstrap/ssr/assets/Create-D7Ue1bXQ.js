import { n as InputSelect, o as InputText } from "./InputPassword-DtsxK0Gz.js";
import { Head, Link, useForm, usePage } from "@inertiajs/react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
//#region resources/js/Pages/Master/jenis-pengiriman/Create.jsx
function Form() {
	const { props } = usePage();
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx(InputSelect, {
									field: "iIdExpedisi",
									label: fieldLabels["iIdExpedisi"] || "iIdExpedisi",
									value: data["iIdExpedisi"] ?? "",
									onChange: (v) => setData("iIdExpedisi", v),
									error: errors["iIdExpedisi"],
									options: selects?.["iIdExpedisi"] || []
								})
							}), /* @__PURE__ */ jsx("div", {
								className: "col-12 col-md-6 col-lg-6",
