...
//#region resources/js/Pages/Master/klasifikasi-perusahaan/Index.jsx
...
function Index() {
	...
	const handleDelete = (id) => {
		if (confirm("Yakin ingin menghapus data ini?")) router.delete(`/master/klasifikasi-perusahaan/${id}`);
	};
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("h6", {
									...
									href: `/master/klasifikasi-perusahaan/create`,
