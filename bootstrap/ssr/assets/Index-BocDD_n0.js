...
//#region resources/js/Pages/Master/tipe-pembayaran/Index.jsx
...
function Index() {
	...
	const handleDelete = (id) => {
		if (confirm("Yakin ingin menghapus data ini?")) router.delete(`/master/tipe-pembayaran/${id}`);
	};
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("h6", {
									...
									href: `/master/tipe-pembayaran/create`,
