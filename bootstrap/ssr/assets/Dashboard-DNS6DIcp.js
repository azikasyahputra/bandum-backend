...
var dashboardMarkup = String.raw`<div class="row">
...
async function createCharts() {
	...
	const charts = [];
	if (chart1) charts.push(new Chart(chart1, {
		type: "line",
		data: {
			labels: [
				"Jan",
	...
	if (chart2) charts.push(new Chart(chart2, {
		type: "bar",
		data: {
			labels: [
				"Jan",
	...
	if (chart3) charts.push(new Chart(chart3, {
		type: "line",
		data: {
			labels: [
				"Jan",
	...
	if (chart4) charts.push(new Chart(chart4, {
		type: "bar",
		data: {
			labels: [
				"Jan",
...
function Dashboard() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Head, { title: "eCommerce Dashboard" }), /* @__PURE__ */ jsx("div", { dangerouslySetInnerHTML: { __html: dashboardMarkup } })] });
}
//#endregion
