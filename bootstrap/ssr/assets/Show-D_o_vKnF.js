...
//#region resources/js/Pages/Master/kategori/Show.jsx
function Show() {
	const { props } = usePage();
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("p", {
										className: "show-field-label",
										children: fieldLabels["vIcon"] || "vIcon"
									}), /* @__PURE__ */ jsx("p", {
										className: "show-field-value",
										children: formatFile("vIcon")
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "col-12 col-md-6 col-lg-4",
									children: [/* @__PURE__ */ jsx("p", {
										className: "show-field-label",
										children: fieldLabels["vIconColor"] || "vIconColor"
									}), /* @__PURE__ */ jsx("p", {
										className: "show-field-value",
										children: formatValue("vIconColor")
									})]
								})
							]
						}),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("p", {
									className: "show-field-label",
									children: fieldLabels["vBackground"] || "vBackground"
								}), /* @__PURE__ */ jsx("p", {
									className: "show-field-value",
									children: formatValue("vBackground")
								})]
							}), /* @__PURE__ */ jsxs("div", {
								className: "col-12 col-md-6 col-lg-4",
								children: [/* @__PURE__ */ jsx("p", {
									className: "show-field-label",
									children: fieldLabels["eFeatured"] || "eFeatured"
								}), /* @__PURE__ */ jsx("p", {
									className: "show-field-value",
									children: formatValue("eFeatured")
								})]
							})]
						}),
