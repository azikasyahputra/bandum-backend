...
//#region resources/js/Pages/Master/artikel/Show.jsx
function Show() {
	const { props } = usePage();
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("p", {
									className: "show-field-label",
									children: fieldLabels["vIsi"] || "vIsi"
								}), /* @__PURE__ */ jsx("p", {
									className: "show-field-value",
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("p", {
									className: "show-field-label",
									children: fieldLabels["vThumbnails"] || "vThumbnails"
								}), /* @__PURE__ */ jsx("p", {
									className: "show-field-value",
									children: formatFile("vThumbnails")
								})]
							}), /* @__PURE__ */ jsxs("div", {
								className: "col-12 col-md-6 col-lg-6",
								children: [/* @__PURE__ */ jsx("p", {
