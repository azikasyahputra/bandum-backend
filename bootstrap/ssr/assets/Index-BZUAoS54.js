...
//#region resources/js/Pages/Master/jenis-pengiriman/Index.jsx
var TABLE_COLUMNS = ["iIdExpedisi", "vNama"];
function Index() {
	const { props } = usePage();
	...
	const handleSearch = (col, value) => {
		...
		const timer = setTimeout(() => {
			router.get(`/master/jenis-pengiriman`, params, {
				preserveState: true,
				replace: true
			});
		}, 300);
	...
	const handleDelete = (id) => {
		if (confirm("Yakin ingin menghapus data ini?")) router.delete(`/master/jenis-pengiriman/${id}`);
	};
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("h6", {
									...
									href: `/master/jenis-pengiriman/create`,
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("table", {
									...
									children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
										...
										/* @__PURE__ */ jsxs("th", { children: [/* @__PURE__ */ jsx("h6", { children: "Ekspedisi" }), /* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsx("svg", {
												...
												value: inputs["iIdExpedisi"] || "",
												onChange: (e) => handleSearch("iIdExpedisi", e.target.value)
											})]
										})] }, "iIdExpedisi"),
										...
										/* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsx("p", { children: formatValue("iIdExpedisi", item["iIdExpedisi"]) }) }, "iIdExpedisi"),
										...
										/* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsxs("div", {
											...
											children: [
												...
												/* @__PURE__ */ jsx(Link, {
													href: `/master/jenis-pengiriman/${item[primaryKey]}`,
													className: "text-success action-btn",
													title: "Lihat",
													children: /* @__PURE__ */ jsx("i", { className: "lni lni-eye" })
												}),
												/* @__PURE__ */ jsx(Link, {
													href: `/master/jenis-pengiriman/${item[primaryKey]}/edit`,
