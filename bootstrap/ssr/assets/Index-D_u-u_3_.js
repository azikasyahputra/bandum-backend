...
//#region resources/js/Pages/Master/provinsi/Index.jsx
var TABLE_COLUMNS = [
	"vNama",
	"vIbukota",
	"vBsni"
...
function Index() {
	...
	const handleDelete = (id) => {
		if (confirm("Yakin ingin menghapus data ini?")) router.delete(`/master/provinsi/${id}`);
	};
