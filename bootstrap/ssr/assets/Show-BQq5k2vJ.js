...
//#region resources/js/Pages/Master/testimoni/Show.jsx
function Show() {
	const { props } = usePage();
					...
					children: [
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("p", {
										...
										children: fieldLabels["iIdTransaksi"] || "iIdTransaksi"
									}), /* @__PURE__ */ jsx("p", {
										className: "show-field-value",
										children: formatValue("iIdTransaksi")
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "col-12 col-md-6 col-lg-4",
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("p", {
										className: "show-field-label",
										children: fieldLabels["vJudul"] || "vJudul"
									}), /* @__PURE__ */ jsx("p", {
										className: "show-field-value",
										children: formatValue("vJudul")
									})]
								})
							]
						}),
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("p", {
									className: "show-field-label",
									children: fieldLabels["vReview"] || "vReview"
								}), /* @__PURE__ */ jsx("p", {
									className: "show-field-value",
									children: formatValue("vReview")
								})]
							})
						}),
