import { o as InputText, r as InputEnum } from "./InputPassword-DtsxK0Gz.js";
import { Head, Link, useForm, usePage } from "@inertiajs/react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
//#region resources/js/Pages/Master/gudang/Create.jsx
function Form() {
	const { props } = usePage();
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx(InputEnum, {
									field: "eStatus",
									label: fieldLabels["eStatus"] || "eStatus",
									value: data["eStatus"] ?? "",
									onChange: (v) => setData("eStatus", v),
									error: errors["eStatus"],
									options: selects?.["eStatus"] || []
								})
							})]
						}), /* @__PURE__ */ jsx("div", {
