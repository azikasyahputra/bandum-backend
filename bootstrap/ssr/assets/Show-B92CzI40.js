...
//#region resources/js/Pages/Master/banner/Show.jsx
function Show() {
	const { props } = usePage();
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("p", {
										className: "show-field-label",
										children: fieldLabels["vTitle"] || "vTitle"
									}), /* @__PURE__ */ jsx("p", {
										className: "show-field-value",
										children: formatValue("vTitle")
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "col-12 col-md-6 col-lg-4",
									children: [/* @__PURE__ */ jsx("p", {
										className: "show-field-label",
										children: fieldLabels["vNamaLink"] || "vNamaLink"
									}), /* @__PURE__ */ jsx("p", {
										className: "show-field-value",
										children: formatValue("vNamaLink")
									})]
								})
							]
						}),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("p", {
										className: "show-field-label",
										children: fieldLabels["vLink"] || "vLink"
									}), /* @__PURE__ */ jsx("p", {
										className: "show-field-value",
										children: formatValue("vLink")
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "col-12 col-md-6 col-lg-4",
									children: [/* @__PURE__ */ jsx("p", {
										className: "show-field-label",
										children: fieldLabels["vImage"] || "vImage"
									}), /* @__PURE__ */ jsx("p", {
										className: "show-field-value",
										children: formatFile("vImage")
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "col-12 col-md-6 col-lg-4",
									children: [/* @__PURE__ */ jsx("p", {
										className: "show-field-label",
										children: fieldLabels["eTampil"] || "eTampil"
									}), /* @__PURE__ */ jsx("p", {
										className: "show-field-value",
										children: formatValue("eTampil")
									})]
								})
							]
						}),
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("p", {
									className: "show-field-label",
									children: fieldLabels["vDetail"] || "vDetail"
								}), /* @__PURE__ */ jsx("p", {
									className: "show-field-value",
									children: formatValue("vDetail")
								})]
							})
						}),
