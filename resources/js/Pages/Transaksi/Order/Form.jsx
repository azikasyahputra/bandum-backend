...
export default function Form() {
    ...
    const { data, setData, post, put, processing, errors } = useForm({
        ...defaultHeader,
        details:
            isEdit && item.details ? item.details.map((d) => ({ ...d })) : [],
    });
    ...
    const loadCustomerAlamat = async (customerId) => {
        ...
        try {
            const res = await fetch(
                `/transaksi/order/customer-alamat/${customerId}`,
            );
    ...
    const kemasanByBarang = (barangId) =>
        kemasan.filter((k) => k.iIdBarang == barangId);
                                    ...
                                    <div className="col-12 col-md-6 col-lg-3">
                                        <div className="select-style-1">
                                            ...
                                            <div className="select-position">
                                                <select
                                                    value={
                                                        data.iIdJenisPengiriman
                                                    }
                                                    disabled={readOnly}
                                                    onChange={(e) =>
                                                        handleJenisPengirimanChange(
                                                            e.target.value,
                                                        )
                                                    }
                                                >
