...
const TABLE_COLUMNS = ["iIdExpedisi", "vNama"];
...
export default function Index() {
    ...
    const handleDelete = (id) => {
        if (confirm("Yakin ingin menghapus data ini?")) {
            router.delete(`/master/jenis-pengiriman/${id}`);
        }
    };
                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <div className="d-flex justify-content-between align-items-center mb-10" style={{ gap: 12 }}>
                                ...
                                <Link href={`/master/jenis-pengiriman/create`} className="main-btn primary-btn-outline rounded-full btn-hover btn-sm">
                                ...
                                <table className="table compact-table">
                                    ...
                                    <tbody>
                                        {items.data && items.data.length > 0 ? (
                                            items.data.map((item, idx) => (
                                                <tr key={item[primaryKey]}>
                                                    <td><p>{items.from + idx}</p></td>
                                                        <td key="iIdExpedisi"><p>{formatValue("iIdExpedisi", item["iIdExpedisi"])}</p></td>
                                            ...
                                            <tr>
                                                <td colSpan={4} style={{ textAlign: "center", padding: "20px 8px" }}>
