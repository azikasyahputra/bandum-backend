                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                                ...
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["iIdTransaksi"] || "iIdTransaksi"}</p>
                                    <p className="show-field-value">{formatValue("iIdTransaksi")}</p>
                                </div>
                                <div className="col-12 col-md-6 col-lg-4">
                                ...
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["vJudul"] || "vJudul"}</p>
                                    <p className="show-field-value">{formatValue("vJudul")}</p>
                                </div>
                                </div>
                                ...
                                <div className="col-12">
                                    <p className="show-field-label">{fieldLabels["vReview"] || "vReview"}</p>
                                    <p className="show-field-value">{formatValue("vReview")}</p>
                                </div>
                                </div>
