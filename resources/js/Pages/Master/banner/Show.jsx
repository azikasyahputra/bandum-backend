                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                                ...
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["vNamaLink"] || "vNamaLink"}</p>
                                    <p className="show-field-value">{formatValue("vNamaLink")}</p>
                                </div>
                                </div>

                                <div className="row">
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["vLink"] || "vLink"}</p>
                                    <p className="show-field-value">{formatValue("vLink")}</p>
                                </div>
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["vImage"] || "vImage"}</p>
                                    <p className="show-field-value">{formatFile("vImage")}</p>
                                </div>
                                <div className="col-12 col-md-6 col-lg-4">
                                ...
                                <div className="col-12">
                                    <p className="show-field-label">{fieldLabels["vDetail"] || "vDetail"}</p>
                                    <p className="show-field-value">{formatValue("vDetail")}</p>
                                </div>
                                </div>
