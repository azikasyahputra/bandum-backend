                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                                ...
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["vIbukota"] || "vIbukota"}</p>
                                    <p className="show-field-value">{formatValue("vIbukota")}</p>
                                </div>
                                </div>

                                <div className="row">
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["vBsni"] || "vBsni"}</p>
                                    <p className="show-field-value">{formatValue("vBsni")}</p>
                                </div>
                                </div>
