...
const TABLE_COLUMNS = ["name", "email", "role"];
                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <div className="d-flex justify-content-between align-items-center mb-10" style={{ gap: 12 }}>
                                ...
                                <Link href={`/master/users/create`} className="main-btn primary-btn-outline rounded-full btn-hover btn-sm">
                                            ...
                                            items.data.map((item, idx) => (
                                                <tr key={item[primaryKey]}>
                                                    <td><p>{items.from + idx}</p></td>
                                                        <td key="name"><p>{formatValue("name", item["name"])}</p></td>
                                                        <td key="email"><p>{formatValue("email", item["email"])}</p></td>
                                                        <td key="role"><p>{formatValue("role", item["role"])}</p></td>
