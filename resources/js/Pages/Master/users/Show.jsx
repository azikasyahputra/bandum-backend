                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                                ...
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["name"] || "name"}</p>
                                    <p className="show-field-value">{formatValue("name")}</p>
                                </div>
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["email"] || "email"}</p>
                                    <p className="show-field-value">{formatValue("email")}</p>
                                </div>
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["role"] || "role"}</p>
                                    <p className="show-field-value">{formatValue("role")}</p>
                                </div>
                                </div>

                                <div className="row">
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["password"] || "password"}</p>
                                    <p className="show-field-value">{"••••••••"}</p>
                                </div>
                                </div>
