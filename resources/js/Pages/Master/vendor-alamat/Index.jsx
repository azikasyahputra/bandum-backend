...
const TABLE_COLUMNS = ["vNama", "iIdVendor", "iIdProvinsi", "iIdKota", "iIdKecamatan", "iIdKelurahan", "vGPS", "vNotelp", "vNohp", "vAlamat", "eUtama"];
...
export default function Index() {
    ...
    const handleDelete = (id) => {
        if (confirm("Yakin ingin menghapus data ini?")) {
            router.delete(`/master/vendor-alamat/${id}`);
        }
    };
                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <div className="d-flex justify-content-between align-items-center mb-10" style={{ gap: 12 }}>
                                ...
                                <Link href={`/master/vendor-alamat/create`} className="main-btn primary-btn-outline rounded-full btn-hover btn-sm">
                                            ...
                                            items.data.map((item, idx) => (
                                                <tr key={item[primaryKey]}>
                                                    <td><p>{items.from + idx}</p></td>
                                                        ...
                                                        <td key="iIdVendor"><p>{formatValue("iIdVendor", item["iIdVendor"])}</p></td>
