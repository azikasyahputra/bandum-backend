                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                                ...
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["iIdBarang"] || "iIdBarang"}</p>
                                    <p className="show-field-value">{formatValue("iIdBarang")}</p>
                                </div>
                                <div className="col-12 col-md-6 col-lg-4">
                                ...
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["nHarga"] || "nHarga"}</p>
                                    <p className="show-field-value">{formatValue("nHarga")}</p>
                                </div>
                                </div>

                                <div className="row">
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["nHargastrike"] || "nHargastrike"}</p>
