...
const TABLE_COLUMNS = ["vTitle", "vIsi", "eTampil"];
                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <div className="d-flex justify-content-between align-items-center mb-10" style={{ gap: 12 }}>
                                ...
                                <Link href={`/master/faq/create`} className="main-btn primary-btn-outline rounded-full btn-hover btn-sm">
