                                ...
                                <table className="table compact-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th key="iIdBrand" style={{ width: 150, minWidth: 150 }}>
                                                <h6>Brand</h6>
                                                <select
                                                    className="search-input"
                                                ...
                                                >
                                                    ...
                                                    {(selects?.["iIdBrand"] || []).map((opt) => (
                                                        <option key={opt.value} value={opt.value}>{opt.label}</option>
                                                    ))}
                                                </select>
                                            </th>
                                            <th key="iIdKategori" style={{ width: 150, minWidth: 150 }}>
                                                <h6>Kategori</h6>
                                                <select
                                                    className="search-input"
                                                    style={{ minWidth: 100, paddingLeft: 8 }}
                                                ...
                                                >
                                                    <option value="">Semua</option>
                                                    {(selects?.["iIdKategori"] || []).map((opt) => (
                                                        <option key={opt.value} value={opt.value}>{opt.label}</option>
                                                    ))}
                                                </select>
                                            </th>
                                            <th key="iIdSubkategori" style={{ width: 150, minWidth: 150 }}>
                                                <h6>Subkategori</h6>
                                                <select
                                                    className="search-input"
                                                    style={{ minWidth: 100, paddingLeft: 8 }}
                                                ...
                                                >
                                                    <option value="">Semua</option>
                                                    {(selects?.["iIdSubkategori"] || []).map((opt) => (
                                                        <option key={opt.value} value={opt.value}>{opt.label}</option>
                                                    ))}
                                                </select>
                                            </th>
                                            ...
                                            <th key="eBestselling" style={{ width: 120, minWidth: 120 }}>
                                                <h6>Best Selling</h6>
                                                <select
                                                    className="search-input"
                                                    style={{ minWidth: 80, paddingLeft: 8 }}
                                                    value={inputs["eBestselling"] || ""}
                                                    onChange={(e) => handleSearch("eBestselling", e.target.value)}
                                                >
                                                    <option value="">Semua</option>
                                                    {(selects?.["eBestselling"] || []).map((opt) => (
                                                        <option key={opt.value} value={opt.value}>{opt.label}</option>
                                                    ))}
                                                </select>
                                            </th>
                                                            ...
                                                            {relatedTables &&
                                                                relatedTables.map(
                                                                    (rt) => (
                                                                        ...
                                                                        >
                                                                             <i className={rt.route === "barang-media" ? "lni lni-empty-file" : "lni lni-list"}></i>
                                                                        </Link>
                                                                    ),
                                                                )}
                                                            {relatedTables &&
