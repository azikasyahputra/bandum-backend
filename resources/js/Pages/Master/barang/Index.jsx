...
const TABLE_COLUMNS = ["vNama", "iIdBrand", "iIdKategori", "iIdSubkategori", "vDeskripsisingkat", "eBestselling", "vDeskripsidetail"];
                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <div className="d-flex justify-content-between align-items-center mb-10" style={{ gap: 12 }}>
                                ...
                                <Link href={`/master/barang/create`} className="main-btn primary-btn-outline rounded-full btn-hover btn-sm">
                                ...
                                <table className="table compact-table">
                                    ...
                                    <tbody>
                                        {items.data && items.data.length > 0 ? (
                                            items.data.map((item, idx) => (
                                                <tr key={item[primaryKey]}>
                                                    <td><p>{items.from + idx}</p></td>
                                                        ...
                                                        <td key="iIdBrand"><p>{formatValue("iIdBrand", item["iIdBrand"])}</p></td>
                                                        <td key="iIdKategori"><p>{formatValue("iIdKategori", item["iIdKategori"])}</p></td>
                                                        <td key="iIdSubkategori"><p>{formatValue("iIdSubkategori", item["iIdSubkategori"])}</p></td>
                                                        <td key="vDeskripsisingkat"><p>{formatValue("vDeskripsisingkat", item["vDeskripsisingkat"])}</p></td>
                                                        <td key="eBestselling"><p>{formatValue("eBestselling", item["eBestselling"])}</p></td>
                                                        <td key="vDeskripsidetail"><p>{formatValue("vDeskripsidetail", item["vDeskripsidetail"])}</p></td>
                                            ...
                                            <tr>
                                                <td colSpan={11} style={{ textAlign: "center", padding: "20px 8px" }}>
