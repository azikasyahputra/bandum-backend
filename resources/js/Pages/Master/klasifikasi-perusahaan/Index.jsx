...
export default function Index() {
    ...
    const handleSearch = (col, value) => {
        ...
        const timer = setTimeout(() => {
            router.get(`/master/klasifikasi-perusahaan`, params, {
                preserveState: true,
                replace: true,
            });
        }, 300);
    ...
    const handleDelete = (id) => {
        if (confirm("Yakin ingin menghapus data ini?")) {
            router.delete(`/master/klasifikasi-perusahaan/${id}`);
        }
    };
                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <div className="d-flex justify-content-between align-items-center mb-10" style={{ gap: 12 }}>
                                ...
                                <Link href={`/master/klasifikasi-perusahaan/create`} className="main-btn primary-btn-outline rounded-full btn-hover btn-sm">
                                ...
                                <table className="table compact-table">
                                    ...
                                    <tbody>
                                        {items.data && items.data.length > 0 ? (
                                                ...
                                                <tr key={item[primaryKey]}>
                                                    ...
                                                    <td>
                                                        <div className="action d-flex" style={{ gap: 5, alignItems: "center" }}>
                                                            ...
                                                            <Link
                                                                href={`/master/klasifikasi-perusahaan/${item[primaryKey]}`}
                                                            ...
                                                            <Link
                                                                href={`/master/klasifikasi-perusahaan/${item[primaryKey]}/edit`}
                                            ...
                                            <tr>
                                                <td colSpan={3} style={{ textAlign: "center", padding: "20px 8px" }}>
