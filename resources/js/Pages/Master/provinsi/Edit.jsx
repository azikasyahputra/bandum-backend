                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <form onSubmit={submit}>
                                ...
                                <div className="col-12 col-md-6 col-lg-4">
                                    <InputText field="vIbukota" label={fieldLabels["vIbukota"] || "vIbukota"} value={data["vIbukota"] ?? ""} onChange={(v) => setData("vIbukota", v)} error={errors["vIbukota"]} />
                                </div>
                                <div className="col-12 col-md-6 col-lg-4">
                                    <InputText field="vBsni" label={fieldLabels["vBsni"] || "vBsni"} value={data["vBsni"] ?? ""} onChange={(v) => setData("vBsni", v)} error={errors["vBsni"]} />
                                </div>
                                </div>
