...
const TABLE_COLUMNS = ["vNama", "vIbukota", "vBsni"];
...
export default function Index() {
    ...
    const handleDelete = (id) => {
        if (confirm("Yakin ingin menghapus data ini?")) {
            router.delete(`/master/provinsi/${id}`);
        }
    };
                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <div className="d-flex justify-content-between align-items-center mb-10" style={{ gap: 12 }}>
                                ...
                                <Link href={`/master/provinsi/create`} className="main-btn primary-btn-outline rounded-full btn-hover btn-sm">
