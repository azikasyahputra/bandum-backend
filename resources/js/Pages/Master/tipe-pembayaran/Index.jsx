...
export default function Index() {
    ...
    const handleSearch = (col, value) => {
        ...
        const timer = setTimeout(() => {
            router.get(`/master/tipe-pembayaran`, params, {
                preserveState: true,
                replace: true,
            });
        }, 300);
    ...
    const handleDelete = (id) => {
        if (confirm("Yakin ingin menghapus data ini?")) {
            router.delete(`/master/tipe-pembayaran/${id}`);
        }
    };
                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <div className="d-flex justify-content-between align-items-center mb-10" style={{ gap: 12 }}>
                                ...
                                <Link href={`/master/tipe-pembayaran/create`} className="main-btn primary-btn-outline rounded-full btn-hover btn-sm">
                                                ...
                                                <tr key={item[primaryKey]}>
                                                    <td><p>{items.from + idx}</p></td>
                                                        ...
                                                        <div className="action d-flex" style={{ gap: 5, alignItems: "center" }}>
                                                            ...
                                                            <Link
                                                                href={`/master/tipe-pembayaran/${item[primaryKey]}`}
                                                            ...
                                                            <Link
                                                                href={`/master/tipe-pembayaran/${item[primaryKey]}/edit`}
