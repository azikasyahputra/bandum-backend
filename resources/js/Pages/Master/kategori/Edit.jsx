                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <form onSubmit={submit}>
                                ...
                                <div className="col-12 col-md-6 col-lg-4">
                                    <InputFile field="vIcon" label={fieldLabels["vIcon"] || "vIcon"} value={data["vIcon"] ?? ""} onChange={(v) => setData("vIcon", v)} error={errors["vIcon"]} />
                                </div>
                                <div className="col-12 col-md-6 col-lg-4">
                                    <InputText field="vIconColor" label={fieldLabels["vIconColor"] || "vIconColor"} value={data["vIconColor"] ?? ""} onChange={(v) => setData("vIconColor", v)} error={errors["vIconColor"]} />
                                </div>
                                </div>

                                <div className="row">
                                <div className="col-12 col-md-6 col-lg-4">
                                    <InputText field="vBackground" label={fieldLabels["vBackground"] || "vBackground"} value={data["vBackground"] ?? ""} onChange={(v) => setData("vBackground", v)} error={errors["vBackground"]} />
                                </div>
                                <div className="col-12 col-md-6 col-lg-4">
                                    <InputEnum field="eFeatured" label={fieldLabels["eFeatured"] || "eFeatured"} value={data["eFeatured"] ?? ""} onChange={(v) => setData("eFeatured", v)} error={errors["eFeatured"]} options={selects?.["eFeatured"] || []} />
                                </div>
                                </div>
