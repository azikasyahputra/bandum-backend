                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                                ...
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["vIcon"] || "vIcon"}</p>
                                    <p className="show-field-value">{formatFile("vIcon")}</p>
                                </div>
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["vIconColor"] || "vIconColor"}</p>
                                    <p className="show-field-value">{formatValue("vIconColor")}</p>
                                </div>
                                </div>

                                <div className="row">
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["vBackground"] || "vBackground"}</p>
                                    <p className="show-field-value">{formatValue("vBackground")}</p>
                                </div>
                                <div className="col-12 col-md-6 col-lg-4">
                                    <p className="show-field-label">{fieldLabels["eFeatured"] || "eFeatured"}</p>
                                    <p className="show-field-value">{formatValue("eFeatured")}</p>
                                </div>
                                </div>
