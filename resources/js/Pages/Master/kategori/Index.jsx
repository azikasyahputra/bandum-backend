...
const TABLE_COLUMNS = ["vNama", "vIcon", "vIconColor", "vBackground", "eFeatured"];
                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <div className="d-flex justify-content-between align-items-center mb-10" style={{ gap: 12 }}>
                                ...
                                <Link href={`/master/kategori/create`} className="main-btn primary-btn-outline rounded-full btn-hover btn-sm">
                                ...
                                <table className="table compact-table">
                                    ...
                                    <tbody>
                                        {items.data && items.data.length > 0 ? (
                                            items.data.map((item, idx) => (
                                                <tr key={item[primaryKey]}>
                                                    <td><p>{items.from + idx}</p></td>
                                                        ...
                                                        <td key="vIcon"><p>{formatValue("vIcon", item["vIcon"])}</p></td>
                                                        <td key="vIconColor"><p>{formatValue("vIconColor", item["vIconColor"])}</p></td>
                                                        <td key="vBackground"><p>{formatValue("vBackground", item["vBackground"])}</p></td>
                                                        <td key="eFeatured"><p>{formatValue("eFeatured", item["eFeatured"])}</p></td>
                                            ...
                                            <tr>
                                                <td colSpan={9} style={{ textAlign: "center", padding: "20px 8px" }}>
