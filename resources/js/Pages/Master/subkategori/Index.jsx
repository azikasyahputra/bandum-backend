...
const TABLE_COLUMNS = ["iIdKategori", "vNama"];
...
export default function Index() {
    ...
    const handleSearch = (col, value) => {
        ...
        const timer = setTimeout(() => {
            router.get(`/master/subkategori`, params, {
                preserveState: true,
                replace: true,
            });
        }, 300);
    ...
    const handleDelete = (id) => {
        if (confirm("Yakin ingin menghapus data ini?")) {
            router.delete(`/master/subkategori/${id}`);
        }
    };
                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <div className="d-flex justify-content-between align-items-center mb-10" style={{ gap: 12 }}>
                                ...
                                <Link href={`/master/subkategori/create`} className="main-btn primary-btn-outline rounded-full btn-hover btn-sm">
                                                ...
                                                <tr key={item[primaryKey]}>
                                                    ...
                                                    <td>
                                                        <div className="action d-flex" style={{ gap: 5, alignItems: "center" }}>
                                                            ...
                                                            <Link
                                                                href={`/master/subkategori/${item[primaryKey]}`}
                                                            ...
                                                            <Link
                                                                href={`/master/subkategori/${item[primaryKey]}/edit`}
