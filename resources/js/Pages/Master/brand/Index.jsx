...
const TABLE_COLUMNS = ["vNama", "vPicture"];
                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <div className="d-flex justify-content-between align-items-center mb-10" style={{ gap: 12 }}>
                                ...
                                <Link href={`/master/brand/create`} className="main-btn primary-btn-outline rounded-full btn-hover btn-sm">
                                            ...
                                            items.data.map((item, idx) => (
                                                <tr key={item[primaryKey]}>
                                                    <td><p>{items.from + idx}</p></td>
                                                        ...
                                                        <td key="vPicture"><p>{formatValue("vPicture", item["vPicture"])}</p></td>
                                                    <td>
