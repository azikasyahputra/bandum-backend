...
const TABLE_COLUMNS = ["vNama", "iIdCustomer", "iIdProvinsi", "iIdKota", "iIdKecamatan", "iIdKelurahan", "vGPS", "vNotelp", "vNohp", "vAlamat", "eUtama"];
...
export default function Index() {
    ...
    const handleSearch = (col, value) => {
        ...
        const timer = setTimeout(() => {
            router.get(`/master/customer-alamat`, params, {
                preserveState: true,
                replace: true,
            });
        }, 300);
    ...
    const handleDelete = (id) => {
        if (confirm("Yakin ingin menghapus data ini?")) {
            router.delete(`/master/customer-alamat/${id}`);
        }
    };
                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <div className="d-flex justify-content-between align-items-center mb-10" style={{ gap: 12 }}>
                                ...
                                <Link href={`/master/customer-alamat/create`} className="main-btn primary-btn-outline rounded-full btn-hover btn-sm">
                                ...
                                <table className="table compact-table">
                                            ...
                                            <th key="iIdCustomer">
                                                ...
                                                <div className="search-wrap">
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder="Cari"
                                                        className="search-input"
                                                        value={inputs["iIdCustomer"] || ""}
                                                        onChange={(e) => handleSearch("iIdCustomer", e.target.value)}
                                                    />
                                                </div>
                                            </th>
                                            <th key="iIdProvinsi">
                                    ...
                                    <tbody>
                                        {items.data && items.data.length > 0 ? (
                                            items.data.map((item, idx) => (
                                                <tr key={item[primaryKey]}>
                                                    <td><p>{items.from + idx}</p></td>
                                                        ...
                                                        <td key="iIdCustomer"><p>{formatValue("iIdCustomer", item["iIdCustomer"])}</p></td>
                                                        ...
                                                        <td key="iIdKelurahan"><p>{formatValue("iIdKelurahan", item["iIdKelurahan"])}</p></td>
                                                        <td key="vGPS"><p>{formatValue("vGPS", item["vGPS"])}</p></td>
                                                        <td key="vNotelp"><p>{formatValue("vNotelp", item["vNotelp"])}</p></td>
                                                        <td key="vNohp"><p>{formatValue("vNohp", item["vNohp"])}</p></td>
                                                        <td key="vAlamat"><p>{formatValue("vAlamat", item["vAlamat"])}</p></td>
                                                        <td key="eUtama"><p>{formatValue("eUtama", item["eUtama"])}</p></td>
                                                        ...
                                                        <div className="action d-flex" style={{ gap: 5, alignItems: "center" }}>
                                                            ...
                                                            <Link
                                                                href={`/master/customer-alamat/${item[primaryKey]}`}
                                                            ...
                                                            <Link
                                                                href={`/master/customer-alamat/${item[primaryKey]}/edit`}
                                            ...
                                            <tr>
                                                <td colSpan={14} style={{ textAlign: "center", padding: "20px 8px" }}>
