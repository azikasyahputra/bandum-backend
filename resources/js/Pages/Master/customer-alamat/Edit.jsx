                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <form onSubmit={submit}>
                                ...
                                <div className="col-12 col-md-6 col-lg-4">
                                    <InputSelect field="iIdCustomer" label={fieldLabels["iIdCustomer"] || "iIdCustomer"} value={data["iIdCustomer"] ?? ""} onChange={(v) => setData("iIdCustomer", v)} error={errors["iIdCustomer"]} options={selects?.["iIdCustomer"] || []} />
                                </div>
                                <div className="col-12 col-md-6 col-lg-4">
