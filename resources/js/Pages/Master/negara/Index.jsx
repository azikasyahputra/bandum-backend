...
const TABLE_COLUMNS = ["vNama", "vKode"];
...
export default function Index() {
    ...
    const handleDelete = (id) => {
        if (confirm("Yakin ingin menghapus data ini?")) {
            router.delete(`/master/negara/${id}`);
        }
    };
                    ...
                    <div className="col-lg-12">
                        <div className="card-style mb-30">
                            <div className="d-flex justify-content-between align-items-center mb-10" style={{ gap: 12 }}>
                                ...
                                <Link href={`/master/negara/create`} className="main-btn primary-btn-outline rounded-full btn-hover btn-sm">
                                            ...
                                            items.data.map((item, idx) => (
                                                <tr key={item[primaryKey]}>
                                                    <td><p>{items.from + idx}</p></td>
                                                        ...
                                                        <td key="vKode"><p>{formatValue("vKode", item["vKode"])}</p></td>
                                                    <td>
