...
class CustomerAlamatRepository implements CustomerAlamatRepositoryContract
{
    public function paginate(array $columns, array $searchCols, array $queryParams): LengthAwarePaginator
    {
        ...
        if ($iIdCustomer = $queryParams['iIdCustomer'] ?? null) {
    ...
    {
        return CustomerAlamat::where('iId', $id)->firstOrFail();
    }

    public function create(array $data): Model
    {
        $model = new CustomerAlamat;
    ...
    public function resolveForeignKeys(LengthAwarePaginator $paginator): void
    {
        ...
        $iIdCustomerIds = collect($items)->pluck('iIdCustomer')->unique()->filter()->values();
