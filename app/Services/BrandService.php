...
class BrandService
{
    public function __construct(
        private BrandRepositoryContract $repository,
    ) {}
    ...
    public function paginated(Request $request): array
    {
        ...
        if ($vPicture = $request->query('vPicture')) {
    ...
    public function store(Request $request): int
    {
        ...
        $fillable = array_values(array_filter((new Brand)->getFillable(), fn ($c) => !in_array($c, $skip)));
