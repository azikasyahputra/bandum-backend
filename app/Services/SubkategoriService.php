...
class SubkategoriService
{
    public function __construct(
        private SubkategoriRepositoryContract $repository,
    ) {}
    ...
    public function store(Request $request): int
    {
        ...
        $fillable = array_values(array_filter((new Subkategori)->getFillable(), fn ($c) => !in_array($c, $skip)));
    ...
    {
        return $this->repository->byKategori($kategoriId);
    }
